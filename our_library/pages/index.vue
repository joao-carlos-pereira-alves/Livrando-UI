      ...
      <q-card class="col-12 row align-center shadow-0">
        ...
        <q-card-section class="row full-width q-mt-lg">
          <div class="col-12 col-sm-12 col-md-4 col-lg-3"
            :class="{ 'q-pl-md': Number(i) > 1, 'q-py-md': !$q.screen.mobile }" v-for="i in 4" :key="i">
            <BookComponent :book="{}" />
          </div>
        </q-card-section>
      </q-card>
      <div class="col-12 q-py-md text-center">
        <q-icon v-for="page in bookPagination.total" name="circle" class="link q-ma-xs"
          :color="page == bookPagination.page ? 'brown' : 'grey'" size="18px"></q-icon>
      </div>
